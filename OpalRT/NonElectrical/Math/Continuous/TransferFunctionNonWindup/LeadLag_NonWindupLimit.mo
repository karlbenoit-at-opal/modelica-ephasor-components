...
block LeadLag_NonWindupLimit "Lead-Lag block with anti wind-up limiter"
  ...
  OpalRT.NonElectrical.Math.Continuous.TransferFunctionNonWindup.Lag_NonWindupLimit lag_non_windup_limit1(KI = K, TI = T2, VRMAX = MAX, VRMIN = MIN, y_init = y_start) annotation(Placement(visible = true, transformation(origin = {-10, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
