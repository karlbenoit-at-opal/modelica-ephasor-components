...
block PID_NonWindupLimit "PID controller with Non Windup limiter"
  ...
  function derivative
    input Real u;
    input Real x;
    input Real yd "output of the derivative block";
    input Real MAX;
    input Real MIN;
    input Real KP;
    input Real KI;
...
initial equation
  ...
  TD0 = TD;
equation
  connect(limiter1.y, y) annotation(Line(points = {{71, 0}, {93.3694, 0}, {93.3694, 1.08254}, {93.3694, 1.08254}}, color = {0, 0, 127}));
  connect(gain2.y, transferfunction1.u) annotation(Line(points = {{-49, 0}, {-33.4852, 0}, {-33.4852, 0.22779}, {-33.4852, 0.22779}}, color = {0, 0, 127}));
  connect(gain2.u, u) annotation(Line(points = {{-72, 0}, {-94.9886, 0}, {-94.9886, -0.22779}, {-94.9886, -0.22779}}, color = {0, 0, 127}));
  der(x) = derivative(u, x, transferfunction1.y, MAX, MIN, KP, KI);
