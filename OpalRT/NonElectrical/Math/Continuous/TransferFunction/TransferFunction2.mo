...
block TransferFunction2 "Second Order Transfer function, Minimal implementation"
  parameter Real b[:] = {1, 1} "Numerator coefficients of transfer function (e.g., 2*s+3 is specified as {2,3})";
  parameter Real a[:] = {1, 1, 1} "Denominator coefficients of transfer function (e.g., 5*s+6 is specified as {5,6})";
...
equation
  ...
  annotation(Diagram(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2})), Diagram(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2}), graphics = {Rectangle(origin = {0.668896, -0.167224}, extent = {{-99.6656, 99.8328}, {99.6656, -99.8328}}), Text(origin = {-1.00552, 6.8598}, extent = {{-68.23, 17.56}, {68.23, -17.56}}, textString = "TransferFunction"), Text(origin = {-8.76565, -14.2732}, extent = {{-46.1564, 5.51987}, {68.23, -17.56}}, textString = "2nd Order")}), Documentation(info = "<html>
<p>
This block is a general purpose second order transfer function.
...
<p>
<b>Note</b>: Unlike Modelica.Blocks.Continuous.TrasferFunction, this block can be used as an FMU for both second and first order transfer functions depending of the denuminator coefficients. If for a certain set of parameters, it leads to a non-proper transfer function, the simulation will stop with an error.
</p>
</html>"), Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2}), graphics={  Rectangle(origin = {0.270636, -0.541272}, extent = {{-99.594, 99.8647}, {99.594, -99.8647}}), Text(origin = {6.63916, 174.982}, extent = {{-101.99, -124.296}, {93.0905, -175.027}}, textString = "Transfer-Function"), Text(origin = {1.52978, -31.3274}, extent = {{-61.16, 31.94}, {61.16, -31.94}}, textString = "2nd Order")}));
end TransferFunction2;
