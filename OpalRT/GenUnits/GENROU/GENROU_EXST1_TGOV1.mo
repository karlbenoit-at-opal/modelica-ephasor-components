...
equation
  connect(dVREF1, exst11.dVREF) annotation(Line(points = {{-69, 5}, {-49.7854, 5}, {-49.7854, 0.429185}, {-15.8798, 0.429185}, {-15.8798, 0.429185}}));
  connect(dGREF1, tgov11.dGREF) annotation(Line(points = {{-67, -24}, {-48.4979, -24}, {-48.4979, -14.1631}, {-13.7339, -14.1631}, {-13.7339, -14.1631}}));
  connect(tgov11.VI, genrou1.VI) annotation(Line(points = {{-14, -26}, {-29.6137, -26}, {-29.6137, -58.7983}, {87.9828, -58.7983}, {87.9828, -3.43348}, {74.6781, -3.43348}, {74.6781, -3.43348}}, color = {0, 0, 127}));
  connect(tgov11.MBASE, genrou1.MBASE) annotation(Line(points = {{-14, -32}, {-24.8927, -32}, {-24.8927, -52.7897}, {84.1202, -52.7897}, {84.1202, -14.1631}, {74.6781, -14.1631}, {74.6781, -14.1631}}, color = {0, 0, 127}));
  connect(tgov11.SLIP, genrou1.SLIP) annotation(Line(points = {{-14, -38}, {-20.6009, -38}, {-20.6009, -48.0687}, {81.1159, -48.0687}, {81.1159, -19.3133}, {73.8197, -19.3133}, {73.8197, -19.3133}}, color = {0, 0, 127}));
  connect(tgov11.PMECH0, genrou1.PMECH0) annotation(Line(points = {{16, -17}, {21.03, -17}, {21.03, -19.3133}, {31.3305, -19.3133}, {31.3305, -19.3133}}, color = {0, 0, 127}));
  connect(exst11.VI, genrou1.VI) annotation(Line(points = {{19.5, 21.5}, {85.4077, 21.5}, {85.4077, -3.43348}, {73.3906, -3.43348}, {73.3906, -3.43348}}, color = {0, 0, 127}));
  ...
  connect(exst11.VOTHSG, exst11.VUEL) annotation(Line(points = {{-15.5, 4.7}, {-29, 4.7}, {-29, 14.5}, {-15.5, 14.5}}, color = {0, 0, 127}));
  annotation(Diagram(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {1, 1})), Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {1, 1}), graphics={  Text(origin = {-24.01, 2.54}, extent = {{-63.44, 25.74}, {113.33, -34.4}}, textString = "GENROU_EXST1_TGOV1"), Rectangle(origin = {0.797267, -6.94761}, extent = {{-100.243, 106.593}, {98.5883, -92.8811}}), Text(origin = {-147.107, 75.6569}, extent = {{62.5647, -2.8652}, {113.33, -34.4}}, textString = "TRIP"), Text(origin = {-146.326, -65.403}, extent = {{59.0139, 0.676099}, {115.458, -29.1991}}, textString = "dVREF"), Text(origin = {-25.9223, -58.4739}, extent = {{74.6167, -9.25298}, {113.33, -34.4}}, textString = "PIN"), Text(origin = {-145.78, -24.67}, extent = {{59.01, 0.68}, {115.46, -29.2}}, textString = "dGREF")}));
end GENROU_EXST1_TGOV1;
