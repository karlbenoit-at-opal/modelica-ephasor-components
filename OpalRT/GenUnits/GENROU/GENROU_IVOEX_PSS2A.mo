...
equation
  connect(genrou1.VI, pss2a1.VI2) annotation(Line(points = {{70, 0}, {85.3722, 0}, {85.3722, -50.4596}, {-91.6455, -50.4596}, {-91.6455, 8.45539}, {-87.0087, 8.45539}, {-87.0087, 8.45539}}, color = {0, 0, 127}));
  connect(genrou1.AccPower, pss2a1.PSS_AUX2[2]) annotation(Line(points = {{70, -5.2}, {81.8264, -5.2}, {81.8264, -46.641}, {-99.5554, -46.641}, {-99.5554, 5.72785}, {-87.0087, 5.72785}, {-87.0087, 5.72785}}, color = {0, 0, 127}));
  connect(genrou1.SLIP, pss2a1.PSS_AUX2[1]) annotation(Line(points = {{70, -16}, {78.0078, -16}, {78.0078, -46.641}, {-99.5554, -46.641}, {-99.5554, 5.72785}, {-86.4632, 5.72785}, {-86.4632, 5.72785}}, color = {0, 0, 127}));
  connect(pss2a1.VI2, pss2a1.VI) annotation(Line(points = {{-87, 8}, {-92.4638, 8}, {-92.4638, 14.456}, {-87.827, 14.456}, {-87.827, 14.456}}, color = {0, 0, 127}));
  connect(dVREF, ivoex1.dVREF) annotation(Line(points = {{-60, -40}, {-55.9147, -40}, {-55.9147, -6.0006}, {-45.2773, -6.0006}, {-45.2773, 4.63683}, {-38.1856, 4.63683}, {-38.1856, 4.63683}}));
  connect(ivoex1.VI, genrou1.VI) annotation(Line(points = {{13, 35}, {76.824, 35}, {76.824, -0.858369}, {70.3863, -0.858369}, {70.3863, -0.858369}}, color = {0, 0, 127}));
  ...
  connect(genrou1.PMECH0, genrou1.PMECH) annotation(Line(points = {{30, -16}, {22, -16}, {22, -12}, {30, -12}}, color = {0, 0, 127}));
  annotation(Diagram(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2})), Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2}), graphics={  Text(origin = {-10.39, -7.27}, extent = {{-75.35, 27.24}, {95.54, -18.69}}, textString = "GENROU_IVOEX_PSS2A"), Rectangle(origin = {0.13947, -0.13947}, extent = {{-99.4421, 99.1632}, {99.4421, -99.1632}}), Text(origin = {-7.7612, -76.2352}, extent = {{47.559, 13.3886}, {95.54, -18.69}}, textString = "PIN")}));
end GENROU_IVOEX_PSS2A;
