...
equation
  connect(ieeeg11.PMECH0, genrou1.PMECH0) annotation(Line(points = {{6, -22}, {12.743, -22}, {12.743, -21.075}, {16.9907, -21.075}, {16.9907, -21.075}}, color = {0, 0, 127}));
  connect(genrou1.MBASE, ieeeg11.MBASE) annotation(Line(points = {{47, -17.1}, {57.507, -17.1}, {57.507, -56.6902}, {-35.7785, -56.6902}, {-35.7785, -37.0855}, {-23.5256, -37.0855}, {-23.5256, -37.0855}}, color = {0, 0, 127}));
  connect(ieeeg11.VI, genrou1.VI) annotation(Line(points = {{-24, -31}, {-41.4966, -31}, {-41.4966, -59.3041}, {60.2844, -59.3041}, {60.2844, -9.14885}, {48.3582, -9.14885}, {48.3582, -9.14885}}, color = {0, 0, 127}));
  connect(dGREF, ieeeg11.dGREF) annotation(Line(points = {{-53, -28}, {-40.3529, -28}, {-40.3529, -18.7878}, {-24.0157, -18.7878}, {-24.0157, -18.7878}}));
  connect(dVREF, esac6a1.dVREF) annotation(Line(points = {{-54, -7}, {-31.5308, -7}, {-31.5308, -5.39128}, {-21.7285, -5.39128}, {-21.7285, -5.39128}}));
  connect(esac6a1.VI, genrou1.VI) annotation(Line(points = {{8, 12}, {60.6684, 12}, {60.6684, -8.99743}, {48.072, -8.99743}, {48.072, -8.99743}}, color = {0, 0, 127}));
  ...
  connect(esac6a1.VOTHSG, esac6a1.VUEL) annotation(Line(points = {{-22, -2.4}, {-31, -2.4}, {-31, 6}, {-22, 6}}, color = {0, 0, 127}));
  annotation(Diagram(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {1, 1})), Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {1, 1}), graphics={  Rectangle(origin = {1.13895, -0.455581}, extent = {{-95.8998, 87.016}, {94.0775, -92.2551}}), Text(origin = {59.2082, -48.8021}, extent = {{25.85, -23.58}, {-7.62995, 1.11752}}, textString = "PIN"), Text(origin = {3.79, 21.66}, extent = {{-90.22, -12.56}, {83.94, -29.04}}, textString = "GENROU_ESAC6A_IEEEG1"), Text(origin = {-56.8041, -62.2026}, extent = {{32.7986, -14.6978}, {-20.16, 17.89}}, textString = "dVREF"), Text(origin = {-39.5506, 67.8396}, extent = {{59.06, -18.94}, {22.2309, 1.83495}}, textString = "TRIP"), Text(origin = {-57.7167, 43.7594}, extent = {{29.363, -8.03091}, {-20.16, 17.89}}, textString = "dGREF")}));
end GENROU_ESAC6A_IEEEG1;
