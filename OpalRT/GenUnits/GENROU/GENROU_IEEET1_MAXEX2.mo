...
model GENROU_IEEET1_MAXEX2
  ...
  OpalRT.Electrical.Control.Excitation.IEEET1 ieeet11(ID = M_ID, TR = TR_ex, KA = KA_ex, TA = TA_ex, VRMAX = VRMAX_ex, VRMIN = VRMIN_ex, KE = KE_ex, TE = TE_ex, KF = KF_ex, TF = TF_ex, Switch = Switch_ex, E1 = E1_ex, SE_E1 = SE_E1_ex, E2 = E2_ex, SE_E2 = SE_E2_ex) annotation(Placement(visible = true, transformation(origin = {-26.5, 15.5}, extent = {{-19.5, -19.5}, {19.5, 19.5}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant const(k = 0) annotation(Placement(visible = true, transformation(origin = {-76, 36}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  ...
  input OpalRT.NonElectrical.Connector.InputInterfacePin dVREF annotation(Placement(visible = true, transformation(origin = {-76, -2}, extent = {{-6.5, -6.5}, {6.5, 6.5}}, rotation = 0)));
equation
  connect(dVREF, ieeet11.dVREF) annotation(Line(points = {{-76, -2}, {-59.4215, -2}, {-59.4215, 4.14002}, {-47.4885, 4.14002}, {-47.4885, 4.14002}}));
  connect(ieeet11.VI, genrou1.VI) annotation(Line(points = {{-7, 27.2}, {41.8873, 27.2}, {41.8873, -0.487062}, {35.5555, -0.487062}, {35.5555, -0.487062}}, color = {0, 0, 127}));
  connect(bus0, genrou1.p) annotation(Line(points = {{65, -25}, {20, -25}, {20, -15}}));
  connect(genrou1.PMECH0, genrou1.PMECH) annotation(Line(points = {{5, -12}, {1.36674, -12}, {1.36674, -9}, {5, -9}}, color = {0, 0, 127}));
  connect(genrou1.TRIP, TRIP) annotation(Line(points = {{20, 15}, {20.2733, 15}, {20.2733, 40}, {20, 40}}, color = {0, 0, 127}));
  connect(ieeet11.EFD0, genrou1.EFD0) annotation(Line(points = {{-7, -0.1}, {-0.5, -0.1}, {-0.5, 0}, {4.7, 0}}, color = {0, 0, 127}));
  connect(ieeet11.EFD, genrou1.EFD) annotation(Line(points = {{-7, 3.8}, {-1.5, 3.8}, {-1.5, 4.2}, {5, 4.2}}, color = {0, 0, 127}));
  connect(ieeet11.ETERM0, genrou1.ETERM0) annotation(Line(points = {{-7, 7.7}, {-0.5, 7.7}, {-0.5, 7.5}, {4.7, 7.5}}, color = {0, 0, 127}));
  connect(ieeet11.EX_AUX, genrou1.EX_AUX) annotation(Line(points = {{-7, 12.77}, {-1.5, 12.77}, {-1.5, 12}, {4.7, 12}}, color = {0, 0, 127}));
  connect(ieeet11.XADIFD, genrou1.XADIFD) annotation(Line(points = {{-46, 25.25}, {-54, 25.25}, {-54, 50}, {46, 50}, {46, 7.5}, {35, 7.5}}, color = {0, 0, 127}));
  connect(maxex21.VOEL, ieeet11.VOEL) annotation(Line(points = {{-67.6, 18}, {-58, 18}, {-58, 13.94}, {-46, 13.94}}, color = {0, 0, 127}));
  connect(const.y, ieeet11.VUEL) annotation(Line(points = {{-70.5, 36}, {-60, 36}, {-60, 19.4}, {-46, 19.4}}, color = {0, 0, 127}));
  connect(ieeet11.VOTHSG, ieeet11.VUEL) annotation(Line(points = {{-46, 8.48}, {-56, 8.48}, {-56, 19.4}, {-46, 19.4}}, color = {0, 0, 127}));
  connect(maxex21.XADIFD, genrou1.XADIFD) annotation(Line(points = {{-87.8, 12}, {-92, 12}, {-92, 50}, {46, 50}, {46, 7.5}, {35, 7.5}}, color = {0, 0, 127}));
  connect(maxex21.EFD, genrou1.EFD) annotation(Line(points = {{-87.8, 24}, {-90, 24}, {-90, -8}, {0, -8}, {0, 4.2}, {5, 4.2}}, color = {0, 0, 127}));
