...
class GENROU_IEEEX1_IEEEST_GAST
  ...
  input OpalRT.NonElectrical.Connector.InputInterfacePin dGREF annotation(Placement(visible = true, transformation(origin = {-68, -38}, extent = {{-8, -8}, {8, 8}}, rotation = 0)));
equation
  connect(dGREF, gast1.dGREF) annotation(Line(points = {{-68, -38}, {-52.7897, -38}, {-52.7897, -23.176}, {-38.1974, -23.176}, {-38.1974, -23.176}}));
  ...
  connect(gast1.MBASE, genrou1.MBASE) annotation(Line(points = {{-38, -42.4}, {-46.9138, -42.4}, {-46.9138, -61.9153}, {54.5509, -61.9153}, {54.5509, -22.6386}, {49.0958, -22.6386}, {49.0958, -22.6386}}, color = {0, 0, 127}));
  connect(genrou1.VI, gast1.VI) annotation(Line(points = {{48, -11}, {57.824, -11}, {57.824, -63.2791}, {-50.1868, -63.2791}, {-50.1868, -35.7308}, {-38.1856, -35.7308}, {-38.1856, -35.7308}}, color = {0, 0, 127}));
  connect(gast1.PMECH0, genrou1.PMECH0) annotation(Line(points = {{-6, -26.4}, {0, -26.4}, {0, -28.0937}, {4.90958, -28.0937}, {4.90958, -28.0937}}, color = {0, 0, 127}));
