...
class GENROU_ST6B_IEEEG1
  ...
  input OpalRT.NonElectrical.Connector.InputInterfacePin dGREF annotation(Placement(visible = true, transformation(origin = {-34, 4}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-36, 24}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
initial equation
  noVUEL = -Modelica.Constants.inf;
equation
  connect(st6b1.VI, genrou1.VI) annotation(Line(points = {{24, 34}, {56.0763, 34}, {56.0763, 20.0379}, {50.9921, 20.0379}, {50.9921, 20.0379}}, color = {0, 0, 127}));
  connect(dGREF, ieeeg11.dGREF) annotation(Line(points = {{-34, 4}, {-18.393, 4}, {-18.393, 14.0565}, {2.24305, 14.0565}, {2.24305, 14.0565}}));
  connect(st6b1.dVREF, dVREF) annotation(Line(points = {{4, 22}, {-27.3653, 22}, {-27.3653, 23.1782}, {-27.3653, 23.1782}}, color = {0, 0, 127}));
  connect(genrou1.MBASE, ieeeg11.MBASE) annotation(Line(points = {{50, 14.6}, {53.8333, 14.6}, {53.8333, -19.2903}, {-4.0375, -19.2903}, {-4.0375, 0.598148}, {2.24305, 0.598148}, {2.24305, 0.598148}}, color = {0, 0, 127}));
  connect(genrou1.VI, ieeeg11.VI) annotation(Line(points = {{50, 20}, {55.9268, 20}, {55.9268, -22.5801}, {-5.83194, -22.5801}, {-5.83194, 4.33657}, {1.94398, 4.33657}, {1.94398, 4.33657}}, color = {0, 0, 127}));
  connect(ieeeg11.PMECH0, genrou1.PMECH0) annotation(Line(points = {{24, 11.6}, {27.3653, 11.6}, {27.3653, 11.963}, {29.3092, 11.963}, {29.3092, 11.963}}, color = {0, 0, 127}));
  ...
  connect(const.y, st6b1.VOTHSG) annotation(Line(points = {{-13, 42}, {-8, 42}, {-8, 24.4}, {4, 24.4}}, color = {0, 0, 127}));
  connect(st6b1.VOEL, st6b1.VOTHSG) annotation(Line(points = {{4, 27.2}, {-8, 27.2}, {-8, 24.4}, {4, 24.4}}, color = {0, 0, 127}));
  connect(st6b1.VUEL, constant1.y) annotation(Line(points = {{4, 30}, {-6, 30}, {-6, 72}, {-9, 72}}, color = {0, 0, 127}));
  connect(st6b1.XADIFD, genrou1.XADIFD) annotation(Line(points = {{4, 33}, {0, 33}, {0, 42}, {54, 42}, {54, 25}, {50, 25}}, color = {0, 0, 127}));
  connect(ieeeg11.PMECH, genrou1.PMECH) annotation(Line(points = {{24, 13.8}, {24, 14}, {30, 14}}, color = {0, 0, 127}));
  connect(genrou1.SLIP, ieeeg11.SLIP) annotation(Line(points = {{50, 12}, {52, 12}, {52, -16}, {-2, -16}, {-2, -3.8}, {2, -3.8}}, color = {0, 0, 127}));
  annotation(Diagram(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2})), Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2}), graphics={  Rectangle(origin = {-1.36674, 26.4237}, extent = {{-88.3827, 36.4465}, {94.3052, -90.4328}}), Text(origin = {-31.8919, -1.02164}, extent = {{-48.06, 27.45}, {116.397, -21.0719}}, textString = "GENROU_ST6B_IEEEG1")}));
