...
class GENROU_EXAC1_IEEEG1
  ...
  Modelica.Blocks.Sources.Constant const(k = 0) annotation(Placement(visible = true, transformation(origin = {-46, -20}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  ...
  input OpalRT.NonElectrical.Connector.InputInterfacePin TRIP annotation(Placement(visible = true, transformation(origin = {60, 38}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, -60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  input OpalRT.NonElectrical.Connector.InputInterfacePin dGREF annotation(Placement(visible = true, transformation(origin = {-72, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, 60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  OpalRT.Electrical.Control.Excitation.EXAC1 exac11(ID = M_ID, TR = TR_ex, TB = TB_ex, TC = TC_ex, KA = KA_ex, TA = TA_ex, VRMAX = VRMAX_ex, VRMIN = VRMIN_ex, TE = TE_ex, KF = KF_ex, TF = TF_ex, KC = KC_ex, KD = KD_ex, KE = KE_ex, E1 = E1_ex, SE_E1 = SE_E1_ex, E2 = E2_ex, SE_E2 = SE_E2_ex) annotation(Placement(visible = true, transformation(origin = {14, 2}, extent = {{-20, -20}, {10, 10}}, rotation = 0)));
  input OpalRT.NonElectrical.Connector.InputInterfacePin dVREF annotation(Placement(visible = true, transformation(origin = {-100, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  connect(exac11.VI, genrou1.VI) annotation(Line(points = {{24, 6}, {78.2806, 6}, {78.2806, -15.0015}, {70.6434, -15.0015}, {70.6434, -15.0015}}, color = {0, 0, 127}));
  connect(ieeeg11.PMECH0, genrou1.PMECH0) annotation(Line(points = {{25, -31}, {32.4578, -31}, {32.4578, -27.2755}, {40.3677, -27.2755}, {40.3677, -27.2755}}, color = {0, 0, 127}));
  connect(dVREF, exac11.dVREF) annotation(Line(points = {{-100, -20}, {-56.4602, -20}, {-56.4602, -27.2755}, {-16.3653, -27.2755}, {-16.3653, -12.274}, {-5.72785, -12.274}, {-5.72785, -12.274}}));
  connect(genrou1.MBASE, ieeeg11.MBASE) annotation(Line(points = {{70, -23.1}, {77.1895, -23.1}, {77.1895, -69.8252}, {-19.3656, -69.8252}, {-19.3656, -46.3683}, {-4.63683, -46.3683}, {-4.63683, -46.3683}}, color = {0, 0, 127}));
  connect(genrou1.VI, ieeeg11.VI) annotation(Line(points = {{70, -15}, {78.2806, -15}, {78.2806, -71.1889}, {-21.8204, -71.1889}, {-21.8204, -40.0949}, {-5.18234, -40.0949}, {-5.18234, -40.0949}}, color = {0, 0, 127}));
  connect(dGREF, ieeeg11.dGREF) annotation(Line(points = {{-72, -40}, {-29.1845, -40}, {-29.1845, -28.7554}, {-6.00858, -28.7554}, {-6.00858, -28.7554}}));
  connect(const.y, exac11.VOTHSG) annotation(Line(points = {{-40.5, -20}, {-22.2725, -20}, {-22.2725, -1.0421}, {-6, -1.0421}, {-6, -8.4}}, color = {0, 0, 127}));
  connect(const.y, exac11.VOEL) annotation(Line(points = {{-40.5, -20}, {-22.2725, -20}, {-22.2725, -4.2485}, {-6, -4.2485}, {-6, -4.2}}, color = {0, 0, 127}));
  connect(const.y, exac11.VUEL) annotation(Line(points = {{-40.5, -20}, {-22.2725, -20}, {-22.2725, -7.2545}, {-6, -7.2545}, {-6, 0}}, color = {0, 0, 127}));
  connect(TRIP, genrou1.TRIP) annotation(Line(points = {{60, 38}, {59.4533, 38}, {59.4533, 21.8679}, {54.8975, 21.8679}, {54.8975, 0}, {55, 0}}));
  connect(bus0, genrou1.p) annotation(Line(points = {{100, -60}, {56, -60}, {56, -28.4738}, {55, -28.4738}, {55, -30}}));
  connect(exac11.EFD0, genrou1.EFD0) annotation(Line(points = {{24, -15}, {32, -15}, {32, -15}, {39.7, -15}}, color = {0, 0, 127}));
  connect(exac11.EFD, genrou1.EFD) annotation(Line(points = {{24, -12}, {32, -12}, {32, -10.8}, {40, -10.8}}, color = {0, 0, 127}));
  connect(exac11.ETERM0, genrou1.ETERM0) annotation(Line(points = {{24, -9}, {32, -9}, {32, -7.5}, {39.7, -7.5}}, color = {0, 0, 127}));
  connect(exac11.EX_AUX, genrou1.EX_AUX) annotation(Line(points = {{24, -5.1}, {33, -5.1}, {33, -3}, {39.7, -3}}, color = {0, 0, 127}));
  connect(exac11.XADIFD, genrou1.XADIFD) annotation(Line(points = {{-6, 4.5}, {-12, 4.5}, {-12, 20}, {76, 20}, {76, -7.5}, {70, -7.5}}, color = {0, 0, 127}));
  connect(ieeeg11.PMECH, genrou1.PMECH) annotation(Line(points = {{25, -28}, {30, -28}, {30, -24}, {40, -24}}, color = {0, 0, 127}));
  connect(ieeeg11.SLIP, genrou1.SLIP) annotation(Line(points = {{-5, -52}, {-18, -52}, {-18, -68}, {76, -68}, {76, -27}, {70, -27}}, color = {0, 0, 127}));
  annotation(Diagram(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2})), Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2}), graphics={  Text(origin = {-51.82, 7.29}, extent = {{-38.61, 12.3}, {138.15, -25.51}}, textString = "GENROU_EXAC1_IEEEG1"), Rectangle(origin = {-0.683371, -0.569476}, extent = {{-99.5444, 98.7472}, {99.5444, -98.7472}}), Text(origin = {77.2165, -60.4778}, extent = {{-15.7169, 9.23023}, {4.55513, -5.58558}}, textString = "PIN")}));
end GENROU_EXAC1_IEEEG1;
