...
class GENROU_EXAC2_PSS2A_GAST
  ...
  OpalRT.Electrical.Control.TurbineGovernor.GAST gast1(R = R_tg, T1 = T1_tg, T2 = T2_tg, T3 = T3_tg, AT = AT_tg, KT = KT_tg, VMAX = VMAX_tg, VMIN = VMIN_tg, DTURB = DTURB_tg, IBUS = IBUS, ID = M_ID) annotation(Placement(visible = true, transformation(origin = {13, -69}, extent = {{-15, -15}, {15, 15}}, rotation = 0)));
  ...
  input OpalRT.NonElectrical.Connector.InputInterfacePin dVREF annotation(Placement(visible = true, transformation(origin = {-40, -28}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
  input OpalRT.NonElectrical.Connector.InputInterfacePin dGREF annotation(Placement(visible = true, transformation(origin = {-40, -56}, extent = {{-5.75, -5.75}, {5.75, 5.75}}, rotation = 0), iconTransformation(origin = {-100, 60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  connect(dGREF, gast1.dGREF) annotation(Line(points = {{-40, -56}, {-7.37737, -56}, {-7.37737, -57.2717}, {-2, -57.2717}, {-2, -57}}));
  connect(dVREF, exac21.dVREF) annotation(Line(points = {{-40, -28}, {-6.79495, -28}, {-6.79495, -12.425}, {-0.582424, -12.425}, {-0.582424, -12.425}}));
  connect(genrou1.AccPower, pss2a1.PSS_AUX2[2]) annotation(Line(points = {{70, -18.9}, {81.5393, -18.9}, {81.5393, -39.6048}, {-58.8248, -39.6048}, {-58.8248, -14.3665}, {-54.7478, -14.3665}, {-54.7478, -14.3665}}, color = {0, 0, 127}));
  connect(genrou1.SLIP, pss2a1.PSS_AUX2[1]) annotation(Line(points = {{70, -27}, {73.7737, -27}, {73.7737, -39.6048}, {-58.8248, -39.6048}, {-58.8248, -14.5606}, {-54.7478, -14.5606}, {-54.7478, -14.5606}}, color = {0, 0, 127}));
  connect(pss2a1.PSS_AUX2, pss2a1.PSS_AUX) annotation(Line(points = {{-55, -14}, {-58.8248, -14}, {-58.8248, -8.54222}, {-54.5537, -8.54222}, {-54.5537, -8.54222}}, color = {0, 0, 127}));
  connect(pss2a1.VI, pss2a1.VI2) annotation(Line(points = {{-55, -6}, {-60.3779, -6}, {-60.3779, -11.6485}, {-55.9127, -11.6485}, {-55.9127, -11.6485}}, color = {0, 0, 127}));
  connect(genrou1.VI, pss2a1.VI2) annotation(Line(points = {{70, -15}, {85.228, -15}, {85.228, -42.3228}, {-60.3779, -42.3228}, {-60.3779, -11.6485}, {-55.5244, -11.6485}, {-55.5244, -11.6485}}, color = {0, 0, 127}));
  connect(exac21.VI, genrou1.VI) annotation(Line(points = {{30, 6}, {85.0339, 6}, {85.0339, -14.9489}, {70.8616, -14.9489}, {70.8616, -14.9489}}, color = {0, 0, 127}));
  connect(genrou1.MBASE, gast1.MBASE) annotation(Line(points = {{70, -23.1}, {77.2682, -23.1}, {77.2682, -90.4698}, {-7.76565, -90.4698}, {-7.76565, -75.3268}, {-2.3297, -75.3268}, {-2.3297, -75.3268}}, color = {0, 0, 127}));
  connect(genrou1.SLIP, gast1.SLIP) annotation(Line(points = {{70, -27}, {73.9678, -27}, {73.9678, -87.3636}, {-5.24181, -87.3636}, {-5.24181, -81.1511}, {-2.3297, -81.1511}, {-2.3297, -81.1511}}, color = {0, 0, 127}));
  connect(genrou1.VI, gast1.VI) annotation(Line(points = {{70, -15}, {85.228, -15}, {85.228, -93.5761}, {-15.5313, -93.5761}, {-15.5313, -69.1143}, {-2.71798, -69.1143}, {-2.71798, -69.1143}}, color = {0, 0, 127}));
  connect(genrou1.PMECH0, gast1.PMECH0) annotation(Line(points = {{40, -27}, {33.7806, -27}, {33.7806, -59.9897}, {29.1212, -59.9897}, {29.1212, -59.9897}}, color = {0, 0, 127}));
  ...
  connect(genrou1.PMECH, gast1.PMECH) annotation(Line(points = {{40, -24}, {32, -24}, {32, -57}, {28, -57}}, color = {0, 0, 127}));
  annotation(Diagram(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2})), Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2}), graphics={  Text(origin = {-51.82, 7.29}, extent = {{-38.61, 12.3}, {138.15, -25.51}}, textString = "GENROU_EXAC2_PSS2A_GAST"), Rectangle(origin = {-0.683371, -0.569476}, extent = {{-99.5444, 98.7472}, {99.5444, -98.7472}}), Text(origin = {77.2165, -60.4778}, extent = {{-15.7169, 9.23023}, {4.55513, -5.58558}}, textString = "PIN"), Text(origin = {-68.1086, 61.7315}, extent = {{-28.7, 7.52}, {28.7, -7.52}}, textString = "dGREF"), Text(origin = {-73.8448, -60.1801}, extent = {{-28.7, 7.52}, {28.7, -7.52}}, textString = "TRIP")}));
