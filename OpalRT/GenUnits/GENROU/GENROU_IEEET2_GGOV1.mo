...
equation
  connect(genrou1.MBASE, ggov11.MBASE) annotation(Line(points = {{42, -15.195}, {53.6481, -15.195}, {53.6481, -73.8197}, {-99.1416, -73.8197}, {-99.1416, -48.927}, {-84.9785, -48.927}, {-84.9785, -48.927}}, color = {0, 0, 127}));
  connect(dGREF, ggov11.dGREF) annotation(Line(points = {{-160, -8}, {-121.888, -8}, {-121.888, -16.7382}, {-85.4077, -16.7382}, {-85.4077, -16.7382}}));
  connect(dVREF, ieeet21.dVREF) annotation(Line(points = {{-158, 20}, {-139.056, 20}, {-139.056, 6.43777}, {-84.1202, 6.43777}, {-84.1202, 6.43777}}));
  connect(genrou1.VI, ggov11.VI) annotation(Line(points = {{42, -0.75}, {57.9399, -0.75}, {57.9399, -78.97}, {-105.15, -78.97}, {-105.15, -37.7682}, {-85.8369, -37.7682}, {-85.8369, -37.7682}}, color = {0, 0, 127}));
  connect(ieeet21.VI, genrou1.VI) annotation(Line(points = {{-28.5, 40.5}, {57.9399, 40.5}, {57.9399, -1.28755}, {43.3476, -1.28755}, {43.3476, -1.28755}}, color = {0, 0, 127}));
