...
equation
  connect(TRIP, genrou1.STATUS) annotation(Line(points = {{-100, 60}, {-59.6811, 60}, {-59.6811, 50.3417}, {-59.6811, 50.3417}}));
  connect(bus0, genrou1.p) annotation(Line(points = {{-26, 32}, {-37.246, 32}, {-37.246, 31.377}, {-49.4357, 31.377}}));
  connect(genrou1.EFD_0, genrou1.EFD) annotation(Line(points = {{-71, 31}, {-72, 31}, {-72, 34}, {-72, 34}}, color = {0, 0, 127}));
  connect(genrou1.PMECH_0, genrou1.PMECH) annotation(Line(points = {{-71, 43}, {-71.5576, 43}, {-71.5576, 45.1467}, {-71.5576, 45.1467}}, color = {0, 0, 127}));
  annotation(Diagram(coordinateSystem(extent = {{-200, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2})), experiment(StartTime = 0, StopTime = 20, Tolerance = 1e-06, Interval = 0.01), Icon(coordinateSystem(extent = {{-200, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2}), graphics={ Rectangle(origin = {-50, 0}, extent = {{-149.774, 100}, {149.774, -100}}), Text(origin = {-91.4822, 3.96282}, extent = {{-72.35, 23.36}, {148.858, -25.9274}}, textString = "GENROUSTATUS"), Text(origin = {77.128, -86.6058}, extent = {{-39.434, 24.942}, {7.19, -8.82}}, textString = "PIN"), Text(origin = {-148.825, 52.0096}, extent = {{-39.43, 24.94}, {7.19, -8.82}}, textString = "TRIP")}));
end GENROUSTATUS;
