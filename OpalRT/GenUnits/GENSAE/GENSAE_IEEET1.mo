...
class GENSAE_IEEET1
  ...
  OpalRT.Electrical.Control.Excitation.IEEET1 ieeet11(ID = M_ID, TR = TR_ex, KA = KA_ex, TA = TA_ex, VRMAX = VRMAX_ex, VRMIN = VRMIN_ex, KE = KE_ex, TE = TE_ex, KF = KF_ex, TF = TF_ex, Switch = Switch_ex, E1 = E1_ex, SE_E1 = SE_E1_ex, E2 = E2_ex, SE_E2 = SE_E2_ex) annotation(Placement(visible = true, transformation(origin = {-45.5, 14.5}, extent = {{-18.5, -18.5}, {18.5, 18.5}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant const(k = 0) annotation(Placement(visible = true, transformation(origin = {-88, 22}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  OpalRT.Electrical.Machine.SynchronousMachine.GENSAE gensae1(IBUS = IBUS, ID = M_ID, P_gen = P_gen, Q_gen = Q_gen, Vt_abs = Vt_abs, Vt_ang = Vt_ang, SB = SB, fn = fn, ZSOURCE_RE = ZSOURCE_RE, Tdo_p = Tdo_p, Tdo_s = Tdo_s, Tqo_s = Tqo_s, H = H, D = D, Xd = Xd, Xq = Xq, Xd_p = Xd_p, Xd_s = Xd_s, Xl = Xl, S1 = S1, S12 = S12) annotation(Placement(visible = true, transformation(origin = {0, 0}, extent = {{-18, -18}, {18, 18}}, rotation = 0)));
  input OpalRT.NonElectrical.Connector.InputInterfacePin dVREF annotation(Placement(visible = true, transformation(origin = {-93, 7}, extent = {{-5, -5}, {5, 5}}, rotation = 0), iconTransformation(origin = {-80, 80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  connect(ieeet11.VI, gensae1.VI) annotation(Line(points = {{-27, 25.6}, {24.0343, 25.6}, {24.0343, 0}, {19.7425, 0}, {19.7425, 0}}, color = {0, 0, 127}));
  connect(dVREF, ieeet11.dVREF) annotation(Line(points = {{-93, 7}, {-79.3991, 7}, {-79.3991, 3.00429}, {-64.8069, 3.00429}, {-64.8069, 3.00429}}));
  connect(TRIP, gensae1.TRIP) annotation(Line(points = {{-40, 60}, {0.527704, 60}, {0.527704, 18}, {0, 18}}));
  connect(gensae1.p, bus0) annotation(Line(points = {{0, -18}, {0, -32}, {66, -32}, {66, -34}}));
  connect(ieeet11.EFD0, gensae1.EFD0) annotation(Line(points = {{-27, -0.3}, {-23.5, -0.3}, {-23.5, 0}, {-18.36, 0}}, color = {0, 0, 127}));
  connect(ieeet11.EFD, gensae1.EFD) annotation(Line(points = {{-27, 3.4}, {-23.5, 3.4}, {-23.5, 5.04}, {-18, 5.04}}, color = {0, 0, 127}));
  connect(ieeet11.ETERM0, gensae1.ETERM0) annotation(Line(points = {{-27, 7.1}, {-22.5, 7.1}, {-22.5, 9}, {-18.36, 9}}, color = {0, 0, 127}));
  connect(ieeet11.EX_AUX, gensae1.EX_AUX) annotation(Line(points = {{-27, 11.91}, {-23.5, 11.91}, {-23.5, 14.4}, {-18.36, 14.4}}, color = {0, 0, 127}));
  connect(ieeet11.XADIFD, gensae1.XADIFD) annotation(Line(points = {{-64, 23.75}, {-74, 23.75}, {-74, 40}, {30, 40}, {30, 9}, {18, 9}}, color = {0, 0, 127}));
  connect(const.y, ieeet11.VUEL) annotation(Line(points = {{-82.5, 22}, {-78, 22}, {-78, 18.2}, {-64, 18.2}}, color = {0, 0, 127}));
  connect(ieeet11.VOEL, ieeet11.VUEL) annotation(Line(points = {{-64, 13.02}, {-72, 13.02}, {-72, 18}, {-64, 18.2}}, color = {0, 0, 127}));
  connect(gensae1.PMECH0, gensae1.PMECH) annotation(Line(points = {{-18, -14.4}, {-22, -14.4}, {-22, -10.8}, {-18, -10.8}}, color = {0, 0, 127}));
  connect(ieeet11.VOTHSG, ieeet11.VOEL) annotation(Line(points = {{-64, 7.84}, {-72, 7.84}, {-72, 13.02}, {-64, 13.02}}, color = {0, 0, 127}));
  annotation(Diagram(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2})), Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2}), graphics={  Rectangle(extent = {{-100, 100}, {100, -100}}), Text(origin = {-4, 2}, extent = {{-58, 29}, {58, -29}}, textString = "GENSAE_IEEET1"), Text(origin = {70, -80}, extent = {{-30, 14}, {30, -14}}, textString = "PIN")}));
end GENSAE_IEEET1;
