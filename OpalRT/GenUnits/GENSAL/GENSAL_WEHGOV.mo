...
class GENSAL_WEHGOV
  ...
  input OpalRT.NonElectrical.Connector.InputInterfacePin dGREF annotation(Placement(visible = true, transformation(origin = {-78, 4}, extent = {{-7, -7}, {7, 7}}, rotation = 0), iconTransformation(origin = {-96, -72}, extent = {{-14.5, -14.5}, {14.5, 14.5}}, rotation = 0)));
...
equation
  connect(gensal1.VI, wehgov1.VI) annotation(Line(points = {{85.5, 18}, {103.599, 18}, {103.599, -65.0386}, {-49.3573, -65.0386}, {-49.3573, -20.5656}, {-34.1902, -20.5656}, {-34.1902, -20.5656}}, color = {0, 0, 127}));
  connect(gensal1.MBASE, wehgov1.MBASE) annotation(Line(points = {{85.5, 2.07}, {96.6581, 2.07}, {96.6581, -60.1542}, {-44.2159, -60.1542}, {-44.2159, -30.3342}, {-34.1902, -30.3342}, {-34.1902, -30.3342}}, color = {0, 0, 127}));
  ...
  connect(wehgov1.dGREF, dGREF) annotation(Line(points = {{-32.75, -0.2}, {-77.635, -0.2}, {-77.635, -0.514139}, {-77.635, -0.514139}}, color = {0, 0, 127}));
  ...
  connect(gensal1.EFD0, gensal1.EFD) annotation(Line(points = {{25.91, 18}, {16.4319, 18}, {16.4319, 25.8216}, {24.8826, 25.8216}, {24.8826, 26.7606}, {24.8826, 26.7606}}, color = {0, 0, 127}));
