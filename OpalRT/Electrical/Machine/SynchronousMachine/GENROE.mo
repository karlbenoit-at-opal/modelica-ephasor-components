...
model GENROE "GENROE model with Special Output to connect to PSS blocks and trip command"
...
<p>
GENROE is a model for a round rotor generator that represents the subtransient effects.
</p>
<p>
GENROE has the same model as GENROU except the saturation function is exponential.
</p>
